...
export class RestProvider {
  ...
  checkSlot(content) {
    ...
    let headers = new HttpHeaders()
          ...
          .set('Authorization', 'Bearer ' + token);
    return new Promise((resolve, reject) => {
      this.http.post(apiUrl+'round/checknumberallow', JSON.stringify(content), {headers: headers})
        .subscribe(res => {
          resolve(res);
        }, (err) => {
          reject(err);
  ...
  getReportInfo(content) {
    ...
    let headers = new HttpHeaders()
          ...
          .set('Authorization', 'Bearer ' + token);
    return new Promise((resolve, reject) => {
      this.http.post(apiUrl+'round/getReportInfo', JSON.stringify(content), {headers: headers})
        .subscribe(res => {
          resolve(res);
        }, (err) => {
          reject(err);
  ...
  getMyBetInfo(content) {
    ...
    let headers = new HttpHeaders()
          ...
          .set('Authorization', 'Bearer ' + token);
    return new Promise((resolve, reject) => {
      this.http.post(apiUrl+'round/getMyBetInfo',  JSON.stringify(content), {headers: headers})
        .subscribe(res => {
          resolve(res);
        }, (err) => {
          reject(err);
